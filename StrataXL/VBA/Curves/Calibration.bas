...
Public Sub CalibrationCrossCurrency()

    On Error GoTo ErrorHandler

    Dim ws As Worksheet: Set ws = ThisWorkbook.Sheets("Cross-Currency Calibration")
...
Public Sub CalibrationSingleCurrency()

    On Error GoTo ErrorHandler

    Dim ws As Worksheet: Set ws = ThisWorkbook.Sheets("Single-Currency Calibration")
    Dim cc As Long: cc = ws.UsedRange.Columns.Count
    Dim rc As Long: rc = ws.UsedRange.Rows.Count
